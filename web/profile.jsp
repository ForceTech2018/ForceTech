...
<div id="meniu">
    ...
    <div class="container">
        <form action="profile" method="post" id="formular">
            <div id="security">
            <h1 id="h1securitate">Security</h1>
            <img id="avatarimg" alt="avatar" width="180px" height="200px"  src=""/>
            ...
            <input type="submit" value="Salveaza" id="submitform"/>
        </form>
